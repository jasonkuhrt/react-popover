...
const Popover = createClass({
  ...
  propTypes: {
    ...
    animateExit: T.func,
    animateExitStop: T.func,
    animateEnter: T.func,
    animateEnterStop: T.func,
  },
  getInitialState () {
    return {
      standing: `above`,
  ...
  getDefaultProps () {
    return {
      ...
      animateExit (completionCallback) {
  ...
  open () {
    if (this.state.exiting) this.animateExitStop.call(this)
  ...
  animateExitStop () {
    this.props.animateExitStop.call(this)
    this.setState({ exiting: false })
  },
  animateExit () {
    this.setState({ exiting: true })
    this.props.animateExit.call(this, () => {
  ...
  animateEnterStop () {
    this.props.animateEnterStop.call(this)
  },
  animateEnter () {
    this.props.animateEnter.call(this)
  },
  trackPopover () {
