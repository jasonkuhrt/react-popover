...
export default createClass({
  ...
  resolvePopoverLayout() {
    ...
    let frameCrossStart = this.frameBounds[axis.cross.start] + scrollSize.cross
    let frameCrossEnd = this.frameBounds[axis.cross.end] + scrollSize.cross
    let frameCrossLength = this.frameBounds[axis.cross.size] + scrollSize.cross
    ...
    console.log(center('cross', zone.flow, this.p2), pos[axis.cross.start] - scrollSize.cross)
    let tipCrossPos = (
      center('cross', zone.flow, this.p2)
