...
const Popover = createClass({
    ...
    return {
      ...
      animationHandlers: {
        ...
        exit (completionCallback) {
          ...
          this.exitingAnimationTimer1 = setTimeout(completionCallback, this.props.enterExitTransitionDurationMs)
        },
        enterStop () {
  ...
  animateExitStop () {
    this.props.animationHandlers.exitStop.call(this)
    this.setState({ exiting: false })
  },
  animateExit () {
    this.setState({ exiting: true })
    this.props.animationHandlers.exit.call(this, () => {
  ...
  animateEnterStop () {
    this.props.animationHandlers.enterStop.call(this)
  },
  animateEnter () {
    this.props.animationHandlers.enter.call(this)
  },
  trackPopover () {
