...
export default createClass({
  ...
  resolvePopoverLayout() {
    ...
    pos[axis.cross.start] = center('cross', zone.flow, this.p2) - (this.size[axis.cross.size] / 2)
  ...
  measureTargetBounds() {
    let np = calcBounds(this.targetEl)
  ...
  componentDidUpdate() {
    ...
    this.exitingAnimationTimer2 = setTimeout(() => {
      this.containerEl.classList.remove('is-enter')
      this.containerEl.classList.remove('is-enter-end')
      this.containerEl.classList.add('is-leave')
      this.containerEl.classList.add('is-leave-start')
      setTimeout(() => {
        this.containerEl.classList.remove('is-leave-start')
        this.containerEl.classList.add('is-leave-end')
  ...
  trackPopover() {
    ...
    setTimeout(() => {
      this.containerEl.classList.remove('is-leave')
      this.containerEl.classList.remove('is-leave-start')
      this.containerEl.classList.remove('is-leave-end')
      this.containerEl.classList.add('is-enter')
      this.containerEl.classList.add('is-enter-start')
      setTimeout(() => {
        this.containerEl.classList.remove('is-enter-start')
        this.containerEl.classList.add('is-enter-end')
  ...
  onTargetResize() {
    log('Recalculating layout because _target_ size changed!')
    this.measureTargetBounds()
    this.resolvePopoverLayout()
  },
  onPopoverSizeChange() {
...
function resolveZoneChoice (targetBounds, frameBounds) {
  let l = targetBounds, f = frameBounds
  return [
