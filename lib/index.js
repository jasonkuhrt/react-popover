...
export default createClass({
  ...
  resolvePopoverLayout() {
    ...
    let absoluteCrossStartBound = this.frameBounds[axis.cross.start] + scrollSize[axis.cross.size]
    let absoluteCrossEndBound = this.frameBounds[axis.cross.end] + scrollSize[axis.cross.size]

    if (pos[axis.cross.start] < absoluteCrossStartBound) {
      pos[axis.cross.start] = absoluteCrossStartBound
    } else if (pos[axis.cross.end] > absoluteCrossEndBound) {
      pos[axis.cross.start] = pos[axis.cross.start] - (pos[axis.cross.end] - absoluteCrossEndBound)
    }
