...
class Popover extends React.Component {
  ...
  trackPopover() {
    ...
    Platform.document.addEventListener("mouseenter", this.checkForOuterMovement)
    Platform.document.addEventListener("mouseover", this.checkForOuterMovement)
  ...
  checkForOuterMovement = event => {
    const isOuterMovement =
      !this.containerEl.contains(event.target) &&
      !this.targetEl.contains(event.target)
    if (isOuterMovement) this.props.onOuterMovement(event)
  }
  untrackPopover() {
