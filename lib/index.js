...
export default createClass({
  ...
  resolvePopoverLayout() {
    ...
    let zone = Layout.pickZone({ prefer: this.props.preferPlace }, this.frameBounds, this.p2, this.size)
    this.zone = zone
    log('zone', zone)
    ...
    let pos = Layout.calcRelPos(zone, this.p2, this.size)
    ...
    else if (tipCrossPos > (pos.crossLength - dockingEdgeBufferLength) - this.props.tipSize * 2) tipCrossPos = (pos.crossLength - dockingEdgeBufferLength) - this.props.tipSize * 2
  ...
  measureTargetBounds() {
    let targetBounds = Layout.El.calcBounds(this.targetEl)
    if (!this.p1) {
