/* @flow */
import React, { render, unmountComponentAtNode, createElement, findDOMNode, createClass, DOM as e, PropTypes as t } from 'react'
...
export default createClass({
  ...
  resolvePopoverLayout() {
    ...
    pos[axis.main.start] = (
      ...
      (isBefore ? targetMainStart - mainLength : targetMainEnd)
  ...
  componentDidMount() {
    this.targetEl = React.findDOMNode(this)
    this.trackPopover()
  },
  componentDidUpdate() {
