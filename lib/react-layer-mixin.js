...
const ReactLayerMixin = function () {
  return ({
    componentWillMount () {
    ...
    _layerRender () {
      ...
      if (!layerReactEl) {
        ...
        // ReactDOM.render(E.noscript(), this.layerContainerNode)
        ReactDOM.unstable_renderSubtreeIntoContainer(this, E.noscript(), this.layerContainerNode)
      } else {
        // this.layerReactComponent = ReactDOM.render(layerReactEl, this.layerContainerNode)
