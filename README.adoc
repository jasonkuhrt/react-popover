...
`react-popover` `>= 0.5.0` supports React 16 while `react-popover` `< 0.5.0` works with at least React `15.x.x` and likely down a couple versions. It is no longer actively maintained.
